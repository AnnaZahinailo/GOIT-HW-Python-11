...
def cmd_parser(command_line: str):          
    for cmd in COMMANDS:
        space_case = ' ' if cmd in ('add phone', 'change phone', 'delete phone', 'phone', 'add birthday', 'birthday') else '' #to avoid an incorrect commandline that didn't interrupt the program in received version
